...
button.textContent = "Clear me!";
let svgWrapper = document.querySelector("vsg-wrapper");
...
function update() {
    ...
    drawCircles(state.circle, container);
...
function updateText(data) {
    ...
    text.innerHTML = `There are ${data.length} circles on this page and the average
    color is rgb(0, ${green}, ${blue}.)`;
}
